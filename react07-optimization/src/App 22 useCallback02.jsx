...
// Box 컴포넌트를 정의. 프롭스로 받은 스타일을 div에 적용한다.
...
function App() {
  ...
  //스타일 반환을 위한 함수 선언
  /*
    Step 1 :  App컴포넌트가 렌더링될때마다 새로운 참조값이 부여된다. 따라서
    테마변경을 눌러도 이와 같이 상관없는 '박스키우기'가 출력된다.
  * */
  ...
  /**
     Step 2 :ㅕuseCallback을 함수에 적용한다. size가 변경될때만 새롭게 함수를
...
return (<>
  ...
  <div className="APP" style={{
    ...
    <h2>useCallback()</h2>
    {/* 스핀버튼으로 증감시킨 값이 size를 변경하고, 새롭게 랜더링 한다. */}
