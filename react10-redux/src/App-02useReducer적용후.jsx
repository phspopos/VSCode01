...
/*
  ...
  유사하다. 매개변수의 첫번째 현재상태, 두번째는 상태변경을 위한
  객체를 전달받는다.
*/

const countReducer = ( prevCount, action ) => {
  /*
    매개변수로 전달된 Action객체를 분석해서 스테이트를 변경한 후 반환한다<div className="바"></div>
...
[ state변수명, Dispatch함수] =useReducer( Reducer함수명, 초기값);
  ...
  */
  ...
  /*
    ...
    인수로 전달되는 객체를 Action 이라고 하고, 이를 분석해서 증가, 감소, 리셋
    3가지로 스테이트를 변경한다.
  */
  const down = () => {
