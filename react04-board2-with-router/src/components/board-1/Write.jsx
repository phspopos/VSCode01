...
function Write( props ){
  ...
  //console.log("111 : "+ boardData, setBoardData[0], 
  //nextNo, setNextNo, navigate, nowDate );

  //console.log("날짜 : " + nowDate());
  //console.log("날짜22 : " + nowDate );
  ...
  <article>
    <form onSubmit={ (event) => {
        ...
        // 이벤트객첵의 target속성으로 DOM의 입력값을 읽어옴
     ...
     let addBoardData = { no:nextNo, writer:w, title:t, contents:c, date:nowDate() };
      ...
      console.log("전달한 값 : "+ addBoardData.date );
