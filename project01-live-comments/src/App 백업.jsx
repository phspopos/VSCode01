...
function App() {
  ...
  let addBoardData = { no:nextNo, name:name, contents:contents, date:nowDate() };

  setBoardData( [...boardData, addBoardData ] );

  console.log( " 111 : " + addBoardData.name );
  console.log( " 222 : "+boardData.name, boardData.contents );
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="commentAuthor" placeholder="이름을 입력하세요" name='commentAuthor' />
                        </div>
                        {/* <!-- 댓글 입력 상자 --> */}
                        <label for="commentContent" class="form-label">댓글 내용</label>
                        <textarea class="form-control" id="commentContent" rows="3" placeholder="댓글을 입력하세요" name="commentContent"></textarea>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onClick={ self.close() }>닫기</button>
