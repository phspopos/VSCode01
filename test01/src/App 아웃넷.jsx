...
useLocation 훅
: React   Router를 통해 라우팅된 페이지에서 현제 URL(경로과) 관련된
정보를 얻는데 사용된다. URL경로, 쿼리스트링 등의 관련정보를 제공한다<div className="use"></div>
useSearchParams
  ...
  //별도의 인수 없이 변수를 정의
   ...
   //쿼리스트링의 정보를 얻어오기 위한 변수와 변경을 위한 함수를 정의
    ...
    /*
      ...
      아래 조작을 위한 함수를 실행하면 설정된 값을 읽어올수 있다.
      */
    ...
    const changeMode = () => {
      ...
      /* 파라미터 변경을 위하 ㄴsetXXX함수를 통해 값을 변경한다.
